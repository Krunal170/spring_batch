...
//
//	@Bean
//	public Step multipFormatCopyFileStep() {
//		return this.stepBuilderFactory.get("multipFormatCopyFileStep")
...
//
//	@Bean
//	public Job multipFormatCopyFileJob() {
//		return this.jobBuilderFactory.get("multipFormatCopyFileJob")
//				.start(multipFormatCopyFileStep())
...
//		List<String> realArgs = Collections.singletonList("customerFile=/input/csv/customerMultiFormat.csv");
//
