package com.example.chapter7.orderreader;
...
public class Customer {
	...
	public String toString() {
		return "Customer [businessCustomer=" + businessCustomer + ", registered=" + registered + ", registrationId="
				+ registrationId + ", firstName=" + firstName + ", lastName=" + lastName + ", middleName=" + middleName
				+ ", vip=" + vip + ", companyName=" + companyName + "]";
	}
